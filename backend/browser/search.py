...
def _get_fallback_catalog_products(query: str, min_price: Optional[float] = None, max_price: Optional[float] = None) -> list:
    ...
    # ── Perfumes / Fragrances (+ Indic: attar, itr, खुशबू)
    ...
    # ── Fan / Pankha (Indic: pankhe, pankha, पंखा)
    elif any(w in q_lower for w in ("fan", "pankha", "pankhe", "ceiling fan", "table fan", "exhaust fan", "cooler fan")):
        items = [
            {"name": "Orient Electric Apex-FX 1200mm Ceiling Fan - Pearl White 5 Star", "price": "₹2,499", "price_value": 2499, "url": "https://www.amazon.in/s?k=ceiling+fan", "image": "https://m.media-amazon.com/images/I/61v8gDa1JNL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.3, "review_count": 3800, "is_bestseller": True, "site": "Amazon"},
            {"name": "Havells Leganza 4-Blade 1200mm Ceiling Fan - Bianco Gold", "price": "₹3,199", "price_value": 3199, "url": "https://www.snapdeal.com/search?keyword=ceiling+fan", "image": "https://m.media-amazon.com/images/I/51YJ8JRTSJL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.4, "review_count": 2100, "is_bestseller": False, "site": "Snapdeal"},
            {"name": "Crompton Aura Prime Anti-Dust 1200mm Ceiling Fan - Ivory", "price": "₹1,899", "price_value": 1899, "url": "https://www.amazon.in/s?k=ceiling+fan", "image": "https://m.media-amazon.com/images/I/61S6i2UELFL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.2, "review_count": 5600, "is_bestseller": True, "site": "Amazon"},
            {"name": "Usha Striker Galaxy 1200mm Ceiling Fan - Midnight Blue", "price": "₹2,299", "price_value": 2299, "url": "https://www.snapdeal.com/search?keyword=ceiling+fan", "image": "https://m.media-amazon.com/images/I/51aKo3OQNFL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.1, "review_count": 1450, "is_bestseller": False, "site": "Snapdeal"},
        ]

    # ── Laptops / Computers (+ Indic: laptop, computer)
    ...
    # ── Shoes / Footwear (+ Indic: joote, joota, chappal, जूते)
    ...
    # ── Mobile Phones (+ Indic: mobile, phone, फ़ोन)
    ...
    # ── Clothes / Apparel (+ Indic: kapda, kapde, कपड़े, kurta, shirt)
        ...
        items = [
            {"name": "Amazon Brand - Symbol Men's Regular Fit T-Shirt (Pack of 2)", "price": "₹499", "price_value": 499, "url": "https://www.amazon.in/s?k=men+tshirt", "image": "https://m.media-amazon.com/images/I/71s09u5QBUL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.2, "review_count": 12400, "is_bestseller": True, "site": "Amazon"},
            {"name": "Mast & Harbour Men's Printed Regular Fit Casual Shirt", "price": "₹699", "price_value": 699, "url": "https://www.snapdeal.com/search?keyword=men+shirt", "image": "https://m.media-amazon.com/images/I/81kvSy1CRWL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.0, "review_count": 3200, "is_bestseller": False, "site": "Snapdeal"},
            {"name": "Biba Women's Straight Kurta - Cotton Blend Party Wear", "price": "₹1,299", "price_value": 1299, "url": "https://www.amazon.in/s?k=women+kurta", "image": "https://m.media-amazon.com/images/I/71OvgsMlS0L._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.3, "review_count": 5800, "is_bestseller": True, "site": "Amazon"},
            {"name": "W for Woman Casual Kurti Set - Festive Collection", "price": "₹999", "price_value": 999, "url": "https://www.snapdeal.com/search?keyword=women+kurti", "image": "https://m.media-amazon.com/images/I/71wK-O7YJOL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.1, "review_count": 2700, "is_bestseller": False, "site": "Snapdeal"},
        ]

    # ── Headphones / Earphones (+ Indic: earphone, earbud, headphone)
    elif any(w in q_lower for w in ("headphone", "earphone", "earbud", "earbuds", "headset", "speaker")):
        items = [
            {"name": "boAt Rockerz 450 Pro Bluetooth On-Ear Headphones with 70H Playtime", "price": "₹999", "price_value": 999, "url": "https://www.amazon.in/s?k=headphones", "image": "https://m.media-amazon.com/images/I/61j5Z2lfQkL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.2, "review_count": 18000, "is_bestseller": True, "site": "Amazon"},
            {"name": "boAt Airdopes 141 TWS Earbuds with 42H Playback & ENx Tech", "price": "₹799", "price_value": 799, "url": "https://www.snapdeal.com/search?keyword=earbuds", "image": "https://m.media-amazon.com/images/I/61fCPB6QY2L._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.1, "review_count": 25000, "is_bestseller": True, "site": "Snapdeal"},
            {"name": "Noise Buds VS104 Max True Wireless Earbuds with 45H Playtime", "price": "₹1,299", "price_value": 1299, "url": "https://www.amazon.in/s?k=earbuds", "image": "https://m.media-amazon.com/images/I/61mSYWwnhKL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.0, "review_count": 9200, "is_bestseller": False, "site": "Amazon"},
        ]

    # ── Books (+ Indic: kitab, pustak, किताब)
    elif any(w in q_lower for w in ("book", "books", "novel", "kitab", "pustak")):
        items = [
            {"name": "Atomic Habits - An Easy & Proven Way to Build Good Habits (Paperback)", "price": "₹399", "price_value": 399, "url": "https://www.amazon.in/s?k=books", "image": "https://m.media-amazon.com/images/I/81ANaVZk5LL._AC_UY436_FMwebp_QL65_.jpg", "rating": 4.7, "review_count": 45000, "is_bestseller": True, "site": "Amazon"},
            {"name": "The Alchemist by Paulo Coelho (English Paperback)", "price": "₹199", "price_value": 199, "url": "https://www.snapdeal.com/search?keyword=books", "image": "https://m.media-amazon.com/images/I/71aFt4+OTOL._AC_UY436_FMwebp_QL65_.jpg", "rating": 4.6, "review_count": 38000, "is_bestseller": True, "site": "Snapdeal"},
        ]

    # ── Generic fallback — build a realistic product name from query
    else:
        q_clean = query.strip().title() or "Trending Product"
        # Use a short version if q_clean is too long
        q_short = q_clean[:30] if len(q_clean) > 30 else q_clean
        items = [
            {"name": f"Top Rated {q_short} - Premium Quality Edition", "price": "₹999", "price_value": 999, "url": f"https://www.amazon.in/s?k={quote_plus(query)}", "image": "https://m.media-amazon.com/images/I/61Biwu25a5L._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.4, "review_count": 1250, "is_bestseller": True, "site": "Amazon"},
            {"name": f"Best Value {q_short} - High Performance Pack", "price": "₹649", "price_value": 649, "url": f"https://www.snapdeal.com/search?keyword={quote_plus(query)}", "image": "https://m.media-amazon.com/images/I/61k8n5bQ2TL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.1, "review_count": 830, "is_bestseller": False, "site": "Snapdeal"},
            {"name": f"Popular Choice {q_short} - Everyday Essential", "price": "₹499", "price_value": 499, "url": f"https://www.amazon.in/s?k={quote_plus(query)}", "image": "https://m.media-amazon.com/images/I/61y8B3-3vEL._AC_UL960_FMwebp_QL65_.jpg", "rating": 4.2, "review_count": 980, "is_bestseller": False, "site": "Amazon"},
        ]
